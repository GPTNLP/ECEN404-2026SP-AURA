...
DEVICE_DEFAULT_HEARTBEAT_SECONDS = int(os.getenv("DEVICE_DEFAULT_HEARTBEAT_SECONDS", "3"))
DEVICE_DEFAULT_STATUS_SECONDS = int(os.getenv("DEVICE_DEFAULT_STATUS_SECONDS", "1"))
