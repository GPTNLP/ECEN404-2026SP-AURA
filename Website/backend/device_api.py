...
DEVICE_DEFAULT_POLL_SECONDS = int(os.getenv("DEVICE_DEFAULT_POLL_SECONDS", "5"))
DEVICE_DEFAULT_HEARTBEAT_SECONDS = int(os.getenv("DEVICE_DEFAULT_HEARTBEAT_SECONDS", "30"))
DEVICE_DEFAULT_STATUS_SECONDS = int(os.getenv("DEVICE_DEFAULT_STATUS_SECONDS", "20"))
